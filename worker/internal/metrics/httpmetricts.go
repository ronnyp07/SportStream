...
func (m *metricsHandler) registerHTTPClientMetrics() {
...
func (m *metricsHandler) SchedulerHTTPClientCall(startTime time.Time, method string,
...
func (m *metricsHandler) SchedulerOutgoingHttpRequest(startTime time.Time, method string,
	destination string, responseCode int, platformName string) {
	if responseCode == 0 {
		responseCode = http.StatusInternalServerError
	}
...
func (m *metricsHandler) SchedulerHTTPClientErrorInc(httpErrorCode int, method string,
